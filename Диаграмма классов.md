...
В ходе работы была сгенерирована диаграмма классов, путём использования PlantUML. Она отображает создание тренировки с добавлением упражнений и их статистикой. Стоит отметить, это не единственная возможная диаграмма классов приложения Gym Tracker. Также предоставлен SwiftUI-код и демонстрация его работы.
