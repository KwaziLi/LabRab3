...
struct Exercise {
    ...
    - sets: Int
    - reps: Int
    + Exercise(id: Int, name: String, weight: Double, sets: Int, reps: Int)
}
...
struct Workout {
    ...
    - date: Date
    - exercises: [Exercise]
    + Workout(id: Int, date: Date, exercises: [Exercise])
}

struct ContentView {
    - workouts: [Workout]
    - showAddWorkoutSheet: Bool
    + ContentView(workouts: [Workout], showAddWorkoutSheet: Bool)
}

struct AddExerciseView {
    - workout: Workout
    - exerciseName: String
    - weight: String
    - sets: String
    - reps: String
    - showSheet: Bool
    + AddExerciseView(workout: Workout, showSheet: Bool)
}

struct AddWorkoutView {
    - workouts: [Workout]
    - showAddExerciseSheet: Bool
    - newWorkoutDate: Date
    - newWorkoutExercises: [Exercise]
    - showSheet: Bool
    + AddWorkoutView(workouts: [Workout], showSheet: Bool)
}
...
# Диаграмма классов
![bPIzReCm4CTtFuL7gfeNO8ZIbWnPkaHAXoe3ZKy1bTYLVOXALT-zhZXiu-98PK3oSVU_tttWhSN6u73j6RDeXZFotIUOSsU1Vp7kdf9tik9xXNHIpHKgVa3JgGkPHkWkBLQyriDR3sIqW3QEC_0HdUzzceBanK9P9A8Yw8aWTSU-FVQBDkzwm0orRD1fr-vD1g3qJkXrHZaH6aa5iX0jrWDZa2Uj41GUEnWzp3Wf_iQG-6bk](https://github.com/KwaziLi/LabRab3/assets/78913919/42502c04-7985-4a94-9e74-b2102ebb2d27)
